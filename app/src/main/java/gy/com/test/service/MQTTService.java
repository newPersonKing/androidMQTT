...
public class MQTTService extends Service {
    ...
    public static final String TAG = "cccccccccccccccccccc";
    ...
    private void init() {
        ...
        Log.i("ccccccccccccccc","doConnect=="+doConnect);
        if (doConnect) {
            doClientConnection();
        }
    ...
    private void doClientConnection() {
        Log.i("cccccccccccc","e======"+client.isConnected());
    ...
    private IMqttActionListener iMqttActionListener = new IMqttActionListener() {
        ...
        public void onFailure(IMqttToken arg0, Throwable arg1) {
            Log.i(TAG, "连接失败 ");
            Log.i("ccccccccccc",arg1.getLocalizedMessage());
